...
if (Test-Path $win10iso){
    ...
    Remove-Item  "DS001:\Task Sequences\$TSName" -Force -ErrorAction SilentlyContinue
    ...
    Write-Warning "the smb share is not correctly mounted, reload the machine and re-try the cred!"
    break
